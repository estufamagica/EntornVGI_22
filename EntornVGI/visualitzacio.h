...
void Iluminacio(GLint sh_programID, char ilumin, bool ifix, bool ilu2sides, bool ll_amb, LLUM* lumin, char obj, bool frnt_fcs, bool bc_lin, int step, bool& sw_ilum, bool *sw_mat, bool palcolorF, char paletaF);
...
glm::mat4 Vista_Ortografica(GLuint sh_programID, int prj, GLdouble Raux, CColor col_fons, CColor col_object, char objecte, GLdouble mida, int step,
	...
	bool ifix, bool il2sides, bool eix, CMask3D reixa, CPunt3D hreixa, bool& sw_il, bool *sw_mat, bool palcolorF, char paletaF);
...
glm::mat4 Vista_Geode(GLuint sh_programID, CEsfe3D opv, char VPol, bool pant, CPunt3D tr, CPunt3D trF,
	...
	bool eix, CMask3D reixa, CPunt3D hreixa, bool& sw_il, bool* sw_mat, bool palcolorF, char paletaF);
